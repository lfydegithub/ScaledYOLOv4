            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        plot_one_box(xyxy, im0, label=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/checkpoints/yolov4-csp.weights', help='model.pt path(s)')
    # file/folder, 0 for webcam
    parser.add_argument('--source', type=str,
                        default='/media/holo/C022AA4B225A6D42/data/traffic_sign/test/images/0927_2', help='source')
    ...
    parser.add_argument('--cfg', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/models/yolov4-csp.cfg', help='*.cfg path')

...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='./checkpoints/yolov4-p5.pt', help='initial weights path')
    parser.add_argument(
        '--cfg', type=str, default='./models/yolov4-p5.yaml', help='model.yaml path')
    ...
    parser.add_argument('--batch-size', type=int, default=2,
                        help='total batch size for all GPUs')  # 16

...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/models/yolov4-csp.cfg', help='yolo cfg file')
    parser.add_argument('--weights_file', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/checkpoints/yolov4-csp.weights', help='yolo weights file')
    parser.add_argument('--output_file', type=str,
                        default='yolov4-csp.onnx', help='yolo onnx file')
    parser.add_argument('--strides', nargs='+', type=int,
                        default=[8, 16, 32], help='YOLO model cell size')
    parser.add_argument('--neck', type=str, default='PAN',
                        help='use which kind neck')

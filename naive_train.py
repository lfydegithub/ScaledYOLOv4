...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/checkpoints/yolov4-csp.weights',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/models/yolov4-csp.cfg',
                        help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/data/coco.yaml',
                        help='data.yaml path')
    parser.add_argument('--hyp', type=str,
    default='/home/holo/workspace/pyspace/ScaledYOLOv4-lfy/data/hyp.scratch.yaml',
    ...
    parser.add_argument('--logdir', type=str,
                        default='train_logs/', help='logging directory')
